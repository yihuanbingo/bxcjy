...
if($act=='default')
{
   $sql = "select community_name, property_name, province, city, district, address, lng, lat, intro ,repair_phone ".
...
elseif($act=='qrscene')
{
   ...
   $qr = 'http://represent.bangsoon.cn/represent/qrscene.php';
...
chdir('../');
$smarty->display("represent/intro.htm");
