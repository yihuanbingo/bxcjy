<?php /* Smarty version Smarty-3.1.7, created on 2014-07-28 13:55:28
         compiled from "./templates/represent/intro.htm" */ ?>
<?php /*%%SmartyHeaderCode:87551110953c7878039fe10-89426673%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '414383454c4d116a2ffe6290c8ff84b40e9c72dd' => 
    array (
      0 => './templates/represent/intro.htm',
      1 => 1406526925,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '87551110953c7878039fe10-89426673',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_53c78780471c3',
  'variables' => 
  array (
    'act' => 0,
    'province' => 0,
...
<?php if ($_valid && !is_callable('content_53c78780471c3')) {function content_53c78780471c3($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ('represent/library/page_header.htm', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
	...
	<div class="col_main">
	  <div class="main_hd">
	    <div class="title_tab">
		  <ul class="tab_navs">
		    <li <?php if ($_smarty_tpl->tpl_vars['act']->value=='default'){?>class="selected"<?php }?>><a href="/represent/intro">小区信息</a></li>
		    <li <?php if ($_smarty_tpl->tpl_vars['act']->value=='qrscene'){?>class="selected"<?php }?>><a href="/represent/intro?act=qrscene">二维码下载</a></li>
		  </ul>
		</div>
	  </div>
...
setDistrict(<?php echo $_smarty_tpl->tpl_vars['city']->value;?>
  ...
  <form action="/represent/intro" method="post" enctype="multipart/form-data" id="intro" class="form">
...
" />
   <p class="f_title">报修电话：
   <p class="f_content"><input type="text" name="repair_phone" class="input" value="<?php echo $_smarty_tpl->tpl_vars['row']->value['repair_phone'];?>
" />
...
">
  ...
  <form action="" method="post" id="lbsForm" class="form" >									
	 ...
	 <p class="f_content"><input type="text" id="micro_estate_setaddr" class="input float_l" style="margin-right:5px" required/>	
...
<?php }?>" id="micro_estate_setwd" class="input" style="width:100px"/>			
 ...
 <?php if ($_smarty_tpl->tpl_vars['act']->value=='qrscene'){?>
   <img src="http://xiaoqu.bangsoon.cn/represent/intro?act=getqrscene">
 <?php }?>
