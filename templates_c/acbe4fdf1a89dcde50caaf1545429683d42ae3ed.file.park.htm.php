<?php /* Smarty version Smarty-3.1.7, created on 2014-07-12 13:14:10
         compiled from "./templates/property/park.htm" */ ?>
<?php /*%%SmartyHeaderCode:74034082953c0c4223a8a93-04144107%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'acbe4fdf1a89dcde50caaf1545429683d42ae3ed' => 
    array (
      0 => './templates/property/park.htm',
      1 => 1403441759,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '74034082953c0c4223a8a93-04144107',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53c0c4224b3e3',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53c0c4224b3e3')) {function content_53c0c4224b3e3($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ('property/library/page_header.htm', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
<script type="text/javascript" src="/templates/js/DatePicker.js"></script>
	...
	<div class="col_main">
	  <div class="main_hd">
	    <div class="title_tab">
		  <ul class="tab_navs">
		    <li <?php if ($_smarty_tpl->tpl_vars['act']->value=='default'){?>class="selected"<?php }?>><a href="/property/park">缴费查询</a></li>
			<li <?php if ($_smarty_tpl->tpl_vars['act']->value=='bind'){?>class="selected"<?php }?>><a href="/property/park?act=bind">上传缴费资料</a></li>
		  </ul>
		</div>
	  </div>
...
<form action="/property/park" method="get" enctype="multipart/form-data" name="search">
...
" onClick="setmonth(this, 'yyyy-MM', '2013-01', '2024-12', 1)" readonly="readonly" style="width:80px">
	 ...
	 <td align="center" class="red"><?php if ($_smarty_tpl->tpl_vars['l']->value['status']==1){?><img src="/templates/images/icon/yes.gif"><?php }else{ ?>已欠费<?php }?></td>
	 <td align="center" class="red"><?php if ($_smarty_tpl->tpl_vars['l']->value['arrearage']){?>- ¥ <?php echo $_smarty_tpl->tpl_vars['l']->value['arrearage'];?>
<?php }else{ ?><img src="/templates/images/icon/yes.gif"><?php }?></td>
...
" style="display:none">
  ...
  <tr height="35px">
	...
	<td colspan="7">
	 ...
	 &ensp;
	 <input type="hidden" name="logType" value="log_park">
  ...
  function UpdateLog(id)
  {
	 ...
	 this.deleteLog = function() { 
	   $.post("/property/ajax.php", {
	                      act:'deleteLog', log_id: [id], logType: 'log_park' },
       function(data)
       {
	    var data = json_decode(data);
	    if(data.error==0)
 ...
 <script type="text/javascript">
			KindEditor.ready(function(K) {
				var editor = K.editor({
					...
					uploadJson : '/property/park?act=act_bind'
				});
 ...
 &ensp; <a href="/data/excel/tingchefei.rar"><span class="red" style="text-decoration:underline">下载停车费示例表格</span></a>
 <?php }?>
</div>
