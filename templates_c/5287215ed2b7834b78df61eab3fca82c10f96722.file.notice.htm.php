<?php /* Smarty version Smarty-3.1.7, created on 2014-07-12 13:14:24
         compiled from "./templates/property/notice.htm" */ ?>
<?php /*%%SmartyHeaderCode:22503889353c0c430725491-82614029%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5287215ed2b7834b78df61eab3fca82c10f96722' => 
    array (
      0 => './templates/property/notice.htm',
      1 => 1404550824,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '22503889353c0c430725491-82614029',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53c0c43080302',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53c0c43080302')) {function content_53c0c43080302($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ('property/library/page_header.htm', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
	...
	<div class="col_main">
	  <div class="main_hd">
	    <div class="title_tab">
		  <ul class="tab_navs">
		    <li <?php if ($_smarty_tpl->tpl_vars['act']->value=='default'){?>class="selected"<?php }?>><a href="/property/notice">发新通知</a></li>
			<li <?php if ($_smarty_tpl->tpl_vars['act']->value=='log'||$_smarty_tpl->tpl_vars['act']->value=='preview'){?>class="selected"<?php }?>><a href="/property/notice?act=log">通知记录</a></li>
		  </ul>
		</div>
	  </div>
...
<?php if ($_smarty_tpl->tpl_vars['act']->value=='default'){?>
  ...
  <form action="/property/notice?<?php if ($_smarty_tpl->tpl_vars['key']->value=='update'){?>key=<?php echo $_smarty_tpl->tpl_vars['key']->value;?>
&notice_id=<?php echo $_smarty_tpl->tpl_vars['notice']->value['notice_id'];?>
<?php }?>" id="notice" method="post" enctype="multipart/form-data" class="form">
  <p class="f_title">通知标题：<span class="color999 fontSize12">（标题不多于32个字符）</span>
  <p class="f_content"><input type="text" name="title" class="input" value="<?php echo $_smarty_tpl->tpl_vars['notice']->value['title'];?>
">
  <p class="f_title">通知详情：<span class="color999 fontSize12">（这里输入通知内容，可上传图片）</span>
  <p class="f_content"><textarea name="content" style="width:100%;height:170px"><?php echo $_smarty_tpl->tpl_vars['notice']->value['content'];?>
</textarea>
...
<?php }else{ ?>
 <!-- 绑定数据用于post -->
 <form action="/property/notice" method="post" name="search" enctype="application/x-www-form-urlencoded">
...
?>
  <div class="notice_box">
   <div class="l_box">
   <h2><a href="/property/notice?act=preview&notice_id=<?php echo $_smarty_tpl->tpl_vars['l']->value['notice_id'];?>
"><?php echo $_smarty_tpl->tpl_vars['l']->value['title'];?>
</a></h2> 
   <a href="/property/notice?act=preview&notice_id=<?php echo $_smarty_tpl->tpl_vars['l']->value['notice_id'];?>
"><?php echo $_smarty_tpl->tpl_vars['l']->value['summary'];?>
   ...
   <div class="m_box">
     <a href="/property/notice?act=delete&notice_id=<?php echo $_smarty_tpl->tpl_vars['l']->value['notice_id'];?>
">点击删除</a>
     <a href="/property/notice?key=update&notice_id=<?php echo $_smarty_tpl->tpl_vars['l']->value['notice_id'];?>
">点击编辑</a>
   </div>
   <div class="clear"></div>
   </div>
...
<?php }?>
<?php if ($_smarty_tpl->tpl_vars['act']->value=='update'){?>
  <!-- 修改通知 -->
  <script type="text/javascript" src="/includes/kindeditor/kindeditor-min.js"></script>
  <script type="text/javascript" src="/includes/kindeditor/lang/zh_CN.js"></script> 
  <script type="text/javascript">
  ...
  <form action="/property/notice" id="notice" method="post" enctype="multipart/form-data" class="form">
  <p class="f_title">通知标题：<span class="color999 fontSize12">（标题不多于32个字符）</span>
