...
/* 数据库设置 */
define('HOST','112.124.119.178');
define('DB_USER','root');
define('DB_PASS','20140303Dyw');
define('CHARSET','utf8');//编码
define('DB_NAME','bangsoon');
define('PREFIX','bs_');//表前缀

/* 微信接口配置 */
define('APPID','wxc2705fbb2964ea45');
define('APPSECRET','866c7ca8c3ee3f50a9319ba13f78f930');
define('TOKEN','a23dfa3sdf34llk423oiu242342fasdf');


define('ROOT_PATH',                     './');   // 图片上传根目录

define('CLIENT_HOST',                  'http://api.bangsoon.net/');    //客户端响应服务器
